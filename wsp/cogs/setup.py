...
ROLE_SPECS = [
    ...
    ("on_duty", "On duty"),
    ("high_rank", "High ranking (Major and above)"),
    ("middle_rank", "Middle ranking (Sergeant through Captain)"),
...
WIZARD_STEPS: list[WizardStep] = [
    ...
    WizardStep("role", "high_rank", "Which role is High Rank (Major and above)?"),
    WizardStep("role", "middle_rank", "Which role is Middle Rank (Sergeant through Captain)?"),
